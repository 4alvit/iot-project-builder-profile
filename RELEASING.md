...
This document defines the release policy for **4alvit/iot-project-builder-profile**. The
...
**RC/stable are currently blocked:** Add an application unit test suite before stable release..
...
- No application test suite is committed.
- Add an application unit test suite before stable release.
